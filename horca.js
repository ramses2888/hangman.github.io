function dibujarTablero() {
  ...
  tablero.fillStyle = "#F2F2F2";
  tablero.strokeStyle = "#0A3871"; //color de borde
  tablero.fillRect(0, 0, 1200, 800); //dibuja el fondo
  tablero.beginPath(); //inicia el dibujo
  tablero.moveTo(650, 500);
  tablero.lineTo(900, 500);
  tablero.stroke(); //dibuja el borde
  tablero.closePath(); //termina el dibujo
}
